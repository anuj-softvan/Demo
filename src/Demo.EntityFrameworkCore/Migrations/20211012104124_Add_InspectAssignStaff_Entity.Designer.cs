...
namespace Demo.Migrations
{
    ...
    [Migration("20211012104124_Add_InspectAssignStaff_Entity")]
    partial class Add_InspectAssignStaff_Entity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Demo.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Demo.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Demo.Borrowers.Borrow", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Demo.CivitMeetings.CivitMeeting", b =>
                {
                    ...
                    b.Property<byte>("Compliancestatus")
                        .HasMaxLength(2)
            ...
            modelBuilder.Entity("Demo.InspectSchMeetings.InspectSchAssignStaff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("AcceptRemarks")
                        .HasMaxLength(200)
                    ...
                    b.ToTable("AppInspectSchAssignStaff");
                });
            ...
            modelBuilder.Entity("Demo.MeetingInspector.MeetingInspectors", b =>
                {
                    ...
                    b.ToTable("AppMeetingInspectors");
                });
            ...
            modelBuilder.Entity("Demo.MeetingParticipent.MeetingParticipents", b =>
                {
                    ...
                    b.ToTable("AppMeetingParticipents");
                });

            modelBuilder.Entity("Demo.Students.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Demo.Books.Book", b =>
                {
                    b.HasOne("Demo.Authors.Author", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Demo.Borrowers.Borrow", b =>
                {
                    b.HasOne("Demo.Books.Book", null)
                        .WithMany()
                        .HasForeignKey("BookID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Demo.Students.Student", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Demo.InspectSchMeetings.InspectSchAssignStaff", b =>
                {
                    b.HasOne("Demo.InspectSchMeetings.InspectSchMeeting", "InspectSchMeeting")
                        .WithMany("InspectSchAssignStaffs")
                        .HasForeignKey("InspectSchID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Demo.MeetingParticipent.MeetingParticipents", b =>
                {
                    b.HasOne("Demo.CivitMeetings.CivitMeeting", "CivitMeeting")
                        .WithMany("MeetingParticipents")
                        .HasForeignKey("MeetingID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CivitMeeting");
                });
            ...
            modelBuilder.Entity("Demo.InspectSchMeetings.InspectSchMeeting", b =>
                {
                    b.Navigation("InspectSchAssignStaffs");
